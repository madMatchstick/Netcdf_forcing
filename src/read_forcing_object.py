...
class Forcing(object):
    ...
    def read_forcing(self):
        ...
        #fn = "C:/Users/lcunha/Documents/GitHub/bmi-example-python/bmi_forcing/cat-3872.nc"
    ...
    #         print ("Check units ")
    #         exit(0)
    #     index_beg=int((datetime.fromisoformat(self._start_time)-date_from).total_seconds()/3600)
    #     if(self._end_time==-9):
    #         index_end=index_beg+1
    #     else:
    #         index_end=int((datetime.fromisoformat(self._end_time)-date_from).total_seconds()/3600)
